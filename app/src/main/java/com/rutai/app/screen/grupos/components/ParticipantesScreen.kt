        ...
        Box(
            ...
            if (isLoading) {
                ...
                Column(
                    ...
                    Text(
                        text = context.getString(com.rutai.app.R.string.participants_empty),
    ...
    TopAppBar(
        title = {
            Column {
                ...
                Text(
                    text = context.getString(com.rutai.app.R.string.participants_count, totalIntegrantes),
                    fontSize = 13.sp,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
    ...
    Row(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = if (isCurrentUser) context.getString(com.rutai.app.R.string.you) else integrante.nombre_completo,
                    fontSize = 16.sp,
                ...
                if (integrante.es_creador) {
                    ...
                    Surface(
                        ...
                        Text(
                            text = context.getString(com.rutai.app.R.string.role_creator),
                            fontSize = 11.sp,
                            fontWeight = FontWeight.Bold,
            ...
            Row(
                ...
                Text(
                    text = when (integrante.rol) {
                        "admin" -> context.getString(com.rutai.app.R.string.role_admin)
                        "moderador" -> context.getString(com.rutai.app.R.string.role_moderator)
                        else -> context.getString(com.rutai.app.R.string.role_member)
                    },
                    fontSize = 13.sp,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                ...
                if (!integrante.activo) {
                    Spacer(modifier = Modifier.width(8.dp))
                    Text(
                        text = context.getString(com.rutai.app.R.string.status_inactive),
                        fontSize = 13.sp,
